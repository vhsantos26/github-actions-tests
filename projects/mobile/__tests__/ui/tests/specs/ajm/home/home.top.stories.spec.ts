...
describe('Home screen Top Stories section AJM @homepage @ajm', () => {
  before(async () => {
    await SetupScreen.header.waitForDisplayed();

    const enableChannel = ['ajm'];
    var disableChannel: string[] = ['aje', 'aja', 'ajb', 'ajc', 'ajd'];
  ...
  it('sectionHeader Logo should be visible', async () => {
